...
class HomeMillan extends StatefulWidget {
  const HomeMillan({super.key});

  @override
  State<HomeMillan> createState() => _HomeMillanState();
}

class _HomeMillanState extends State<HomeMillan> {
  int myindex = 0;
  List widgetlist = [
    const Product(),
    const Achats(),
